...
public class BookValidator implements Validator {
    ...
    public void validate(Object o, Errors errors) {
        ...
        if (book.getAuthors(/*"Thomas H. Cormen, Charles E. Leiserson, Ronald L. Rivest and Clifford Stein"*/).length() < 4 || book.getAuthors(/*"Thomas H. Cormen, Charles E. Leiserson, Ronald L. Rivest and Clifford Stein"*/).length() > 150) {
        ...
        if (book.getYear().toString().length() < 10) {
